...
from velociraptor.llm.anthropic import AnthropicClient
...
from velociraptor.utils import ContextManager
...
async def _write_recursive_context(depth: int, conversation_messages: List[Dict[str, Any]], tool_result: Dict[str, Any]) -> None:
...
class MCPAnthropicClient:
    ...
    async def _connect_to_server(self, server: MCPServerInfo) -> Optional[ClientSession]:
            ...
            while turn < max_turns:
                ...
                for tool_call in tool_use_blocks:
                    ...
                    if tool_name == "recursive_query":
                        ...
                        await _write_recursive_context(operating_depth, conversation_messages, tool_result)
